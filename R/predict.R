...
#   Al J Abadi, Melbourne Integrative Genomics, The University of Melbourne, VIC
# created: 27-05-2015
# last modified: 31-09-2019
#
# Copyright (C) 2015
#############################################################################################################
...
#' @param ... arguments passed to the generic. see Details.
#' 
#' @details
#' The function also takes the following arguments:
#' 
#' \itemize{
#' \item \code{newdata.scale}: used in tune/perf functions. pass `newdata' that has been scale already (gain in computational time)
#' \item \code{misdata.all}: used in tune/perf functions. any missing values in object$X
#' \item \code{is.na.X}: used in tune/perf functions. where are the missing values in object$X
#' \item \code{is.na.newdata}: used in tune/perf functions. where are the missing values in `newdata`
#' \item \code{noAveragePredict}:used in tune/perf functions. no calculation of Average Prediction (gain in computational time)
#'
#' }
#' 
...
#' @example examples/predict-example.R
...
predict <- function(object=NULL, newdata=NULL, study.test=NULL, dist=c("all", "max.dist", "centroids.dist", "mahalanobis.dist"), multilevel=NULL, ...){
    UseMethod("predict", object = object)
}
...
#' @export
#' @noMd
predict.mixo_plsda <- predict.mixo_pls

#' @export
#' @noMd
predict.mixo_splsda <- predict.mixo_plsda
...
#' @export
predict.block.spls <- predict.block.pls

#' @export
#' @noMd
predict.block.plsda <- predict.mixo_pls

#' @export
#' @noMd
predict.block.splsda <- predict.block.plsda
...
#' @export
#' @noMd
predict.mint.pls <- predict.mixo_pls

#' @export
#' @noMd
predict.mint.spls <- predict.mint.pls

#' @export
#' @noMd
predict.mint.plsda <- predict.mixo_pls

#' @export
#' @noMd
predict.mint.splsda <- predict.mint.plsda

## ------------ block mint pls

#' @export
#' @noMd
predict.mint.block.pls <- predict.mixo_pls

#' @export
#' @noMd
predict.mint.block.spls <- predict.mint.block.pls

#' @export
#' @noMd
predict.mint.block.plsda <- predict.mixo_pls

#' @export
#' @noMd
predict.mint.block.splsda <- predict.mint.block.plsda